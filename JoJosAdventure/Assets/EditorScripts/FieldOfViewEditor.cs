...
namespace EditorScripts
{
    ...
    public class FieldOfViewEditor : Editor
    {
        private void OnSceneGUI()
        {
            ...
            Vector3 viewAngleA = UtilsClass.DirFromAngleLocal(-fow.viewAngle / 2, fow.transform);
            Vector3 viewAngleB = UtilsClass.DirFromAngleLocal(fow.viewAngle / 2, fow.transform);
